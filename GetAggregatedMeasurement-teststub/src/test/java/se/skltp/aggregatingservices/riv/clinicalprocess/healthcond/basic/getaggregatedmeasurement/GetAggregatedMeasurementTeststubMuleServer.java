...
public class GetAggregatedMeasurementTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedMeasurement-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedMeasurementTeststubMuleServer.class);
